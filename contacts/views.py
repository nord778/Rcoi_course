...
def inquiry(request):
    if request.method == 'POST':
        ...
        first_name=first_name, last_name=last_name, customer_need=customer_need, city=city, state=state, email=email, phone=phone, message=message)
